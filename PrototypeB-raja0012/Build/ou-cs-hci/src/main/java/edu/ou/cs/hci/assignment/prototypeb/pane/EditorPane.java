...
public final class EditorPane extends AbstractPane
{
	...
	private void	updateMoviePropertiesInModel()
	{
		...
		//updated all the properties by getting their key from model and using the get methods from movie class
		...
		controller.set("movie.numberOfReviews", movie.getNumReviews());
		controller.set("movie.genre", movie.getGenres());
