...
public final class Movie
{
	...
	public BooleanProperty	awardPictureProperty() {return awardPicture;}

	public BooleanProperty	awardDirectingProperty() {return awardDirecting;}

	public BooleanProperty	awardCinematographyProperty() {return awardCinematography;}

	public BooleanProperty	awardActingProperty() {return awardActing;}

	public DoubleProperty	averageReviewScoreProperty() {return averageReviewScore;}
	...
	public BooleanProperty	isColorProperty() 	{return isColor;}
	...
	public List<String>	getAllAttributesAsStrings()
	{
		...
		//since genre is set as bits, get the List<String> of genres, use getGenreAsString method provided to turn to string
		List<String> gdata = Resources.getLines("data/genres.txt");
		list.add(getGenreAsString(gdata));
