...
public final class EditorPane extends AbstractPane
{
	...
	private void	registerPropertyListeners(Movie movie)
	{
		...
		movie.awardPictureProperty().addListener(this::handleChangeBoolean);
		movie.awardDirectingProperty().addListener(this::handleChangeBoolean);
		movie.awardCinematographyProperty().addListener(this::handleChangeBoolean);
		movie.awardActingProperty().addListener(this::handleChangeBoolean);

		movie.averageReviewScoreProperty().addListener(this::handleChangeDecimal);
		movie.numberOfReviewsProperty().addListener(this::handleChangeInteger);
		movie.genreProperty().addListener(this::handleChangeGenre);//not yet completed

		movie.directorProperty().addListener(this::handleChangeS);
		movie.isAnimatedProperty().addListener(this::handleChangeBoolean);
		movie.isColorProperty().addListener(this::handleChangeBoolean);

		movie.summaryProperty().addListener(this::handleChangeText);
		movie.commentsProperty().addListener(this::handleChangeText);
	...
	private void	unregisterPropertyListeners(Movie movie)
	{
		...
		movie.awardPictureProperty().removeListener(this::handleChangeBoolean);
		movie.awardDirectingProperty().removeListener(this::handleChangeBoolean);
		movie.awardCinematographyProperty().removeListener(this::handleChangeBoolean);
		movie.awardActingProperty().removeListener(this::handleChangeBoolean);

		movie.averageReviewScoreProperty().removeListener(this::changeDecimal);
		movie.numberOfReviewsProperty().removeListener(this::changeInteger);
		movie.genreProperty().removeListener(this::handleChangeGenre);

		movie.directorProperty().removeListener(this::handleChangeS);
		movie.isAnimatedProperty().removeListener(this::handleChangeBoolean);
		movie.isColorProperty().removeListener(this::handleChangeBoolean);
	...
	//for text area
	private void	handleChangeText(ObservableValue<? extends String> observable,
								  String oldValue, String newValue)
	{
		Movie	movie = (Movie)controller.getProperty("movie");

		if (observable == movie.summaryProperty())
	...
	//for CheckBox
	private void 	handleChangeBoolean(ObservableValue<? extends Boolean> observable,
