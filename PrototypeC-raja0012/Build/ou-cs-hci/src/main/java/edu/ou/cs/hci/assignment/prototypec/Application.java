...
public final class Application extends javafx.application.Application
{
		...
		implements EventHandler<ActionEvent>
	{
		...
		{
			View		view1 = new View(controller, "View 1",  40,  40);//40, 40
			View		view2 = new View(controller, "View 2", 120, 120);//120, 120
			View		view3 = new View(controller, "View 3", 200, 200);//200, 200
